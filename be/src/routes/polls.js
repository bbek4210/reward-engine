...
const pollsData = [
  ...
  },
  {
    id: '9',
    pid: 512,
    image: 'https://images.unsplash.com/photo-1527613426441-4da17471b66d?auto=format&fit=crop&q=80&w=800&v=2',
    title: 'Universal Health Insurance Implementation?',
    question: 'Should the government prioritize Universal Health Insurance?',
    description: 'Vote on whether the government should implement Universal Health Insurance for all citizens.',
    category: 'health',
    type: 'referendum',
    status: 'active',
    constituency: 'NATIONAL',
    ...
    options: [
      ...
      {
        id: 'o2',
        label: 'Partial funding model',
        votes: 88,
        percentage: 20,
        color: '#818CF8',
      },
      { id: 'o3', label: 'No, private model', votes: 44, percentage: 10, color: '#94A3B8' },
    ],
    trendData: [
      { date: 'Mar 15', o1: 65, o2: 25, o3: 10 },
      { date: 'Mar 16', o1: 68, o2: 22, o3: 10 },
      { date: 'Mar 17', o1: 70, o2: 20, o3: 10 },
    ],
    comments: [],
    rules: [
      'One vote per wallet address.',
  ...
  },
  {
    ...
    title: 'Mandatory Vocational Training in Schools?',
    question: 'Should vocational training be mandatory in high schools?',
    description: 'Poll on introducing mandatory vocational skills training in the national curriculum.',
    category: 'education',
    type: 'opinion',
    status: 'active',
    constituency: 'NATIONAL',
    ...
    options: [
      ...
      { id: 'o3', label: 'No, focus on academics', votes: 20, percentage: 9, color: '#94A3B8' },
    ],
    trendData: [
      { date: 'Mar 16', o1: 65, o2: 25, o3: 10 },
      { date: 'Mar 17', o1: 70, o2: 21, o3: 9 },
    ],
    comments: [],
    rules: [
      'One vote per wallet address.',
  ...
  },
  {
    ...
    title: 'Strict Enforcement of Plastic Bag Ban?',
    question: 'Should the government strictly enforce the plastic bag ban?',
    description: 'Opinion on whether to impose heavy fines for using thin plastic bags.',
    category: 'environment',
    type: 'survey',
    status: 'active',
    constituency: 'KATHMANDU',
    ...
    options: [
      ...
      {
        id: 'o2',
        label: 'Incentivize alternatives',
        votes: 60,
        percentage: 19,
        color: '#60A5FA',
      },
      { id: 'o3', label: 'No enforcement needed', votes: 20, percentage: 6, color: '#FBBF24' },
    ],
    trendData: [
      { date: 'Mar 16', o1: 70, o2: 20, o3: 10 },
      { date: 'Mar 17', o1: 75, o2: 19, o3: 6 },
    ],
    comments: [],
    rules: [
      'One vote per wallet address.',
  ...
  },
  {
    ...
    title: 'Transition to Solar Street Lighting?',
    question: 'Should all street lights be transitioned to solar power?',
    description: 'Poll on moving the entire city street lighting system to solar energy.',
    category: 'infrastructure',
    type: 'opinion',
    status: 'active',
    constituency: 'NATIONAL',
    ...
    options: [
      ...
      {
        id: 'o2',
        label: 'Phase in over 5 years',
        votes: 40,
        percentage: 22,
        color: '#34D399',
      },
      { id: 'o3', label: 'No, too expensive', votes: 10, percentage: 6, color: '#E11D48' },
    ],
    trendData: [
      { date: 'Mar 17', o1: 70, o2: 20, o3: 10 },
      { date: 'Mar 18', o1: 72, o2: 22, o3: 6 },
    ],
    comments: [],
    rules: [
      'One vote per wallet address.',

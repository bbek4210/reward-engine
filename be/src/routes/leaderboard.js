...
const mockCitizens = [
  {
    ...
    name: "Aayush Sharma",
    handle: "aayush",
    walletAddress: "FKBfos9xQv3mNpVWMqzpPdRWMqhNk7tYuBaLc2WMqH",
    points: 2450,
  ...
  },
  {
    ...
    name: "Priya Thapa",
    handle: "priyat",
    walletAddress: "9mKs3xRtYpLw4nBqVzDcFjH8eAoGiMuNbPsXkQvWr",
    points: 2210,
  ...
  },
  {
    ...
    name: "Rajan Karki",
    handle: "rajanK",
    walletAddress: "3vPxT7mYkLs2nQwBcZdFhJ6gRoAiUeNtGpXjWvMs",
    points: 2090,
  ...
  },
  {
    ...
    name: "Sunita Limbu",
    handle: "sunita",
    walletAddress: "BqWn5xKm8tLr3oPvYzCdFhA9gJiUeNkGsXpWjMvTs",
    points: 1870,
  ...
  },
  {
    ...
    name: "Bikash Rai",
    handle: "bikash",
    walletAddress: "7nRpL4kMs2xQwBvZdFhJ8eAoGiUmNtCpXjWvKsYr",
    points: 1740,
    constituency: "Butwal",
    type: "citizen",
    streakDays: 8,
  ...
  },
  {
    ...
    name: "Anita Paudel",
    handle: "anitap",
    walletAddress: "DmVx6wKs3tLr4oPnYzCbFhA9gJiUeNkGqXpWjMvRs",
    points: 1610,
    constituency: "Kathmandu-3",
    type: "citizen",
    streakDays: 7,
  ...
  },
  {
    ...
    name: "Hari Prasad",
    handle: "harip",
    walletAddress: "EkBn5xQv3mNpVWMqzPdRWLqhNk7tYuBaLc2WMqHs",
    points: 1520,
  ...
  },
  {
    ...
    name: "Kulman Fan",
    handle: "kulman",
    walletAddress: "GpWs8xTm4tLr2oPvYzNdFhJ6gRoAiUeNkCqXjWvMs",
    points: 1380,
    constituency: "Kathmandu-3",
    type: "citizen",
    streakDays: 6,
  ...
  },
  {
    ...
    name: "Sagar Thapa",
    handle: "sagart",
    walletAddress: "HrVn5xKm8tLq3oPvYzCdFhA9gJiUeNkGsXpWjMvTs",
    points: 1240,
  ...
  },
  {
    ...
    name: "Meena Shrestha",
    handle: "meenas",
    walletAddress: "JsBp6xQv4mNpVWMqzRdLWMqhNk8tYuBaLc3WMqHs",
    points: 1120,
  ...
  },
  {
    ...
    name: "Dipesh Gurung",
    handle: "dipesh",
    walletAddress: "KtWn7xKm5tLr2oPvYzCdFhA6gJiUeNkGqXpWjMvRs",
    points: 1010,
  ...
  },
  {
    ...
    name: "Nisha Tamang",
    handle: "nishat",
    walletAddress: "LuBq8xQv3mNpVWMqzPdRWLqhNk5tYuBaLc4WMqHs",
    points: 920,
...
router.get("/spotlight", (req, res) => {
  ...
  res.json({
    ...
    data: {
      ...
      topContributor:
        topCitizen?.handle || topCitizen?.name.split(" ")[0] || "Anonymous",
